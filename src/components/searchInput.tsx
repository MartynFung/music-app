...
export function SearchInput({ searchValue, setSearchValue, debounceTimeMs, placeholder = "Search" }: Props): React.JSX.Element {
    ...
    const handleClickOutside = (event: MouseEvent) => {
        if (inputRef.current && !inputRef.current.contains(event.target as Node) && inputValue === "") {
            setIsOpen(false);
        }
    };
